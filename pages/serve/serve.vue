      ...
      <view class="fw-list" v-for="(item,index) in fuwu" :key="index">
        <view class="fw-l">
          ...
          <view class="fw-but">
            ...
            <uv-button type="primary" :plain="true" :hairline="true" text="取消订单" size="large" shape="circle"
              color="#a8a8a8"></uv-button>
            <uv-button type="primary" :plain="true" :hairline="true" text="立即付款" size="large" shape="circle"
